...
public class Customer {
	@Id
	@SequenceGenerator(initialValue = 1001, name = "customer_seq", sequenceName = "customer_seq", allocationSize = 1)
...
//	@Pattern(regexp="[a-zA-Z\\s]",message="Not a valid name")
	...
	public Customer(int customerID, @NotEmpty String firstName, @NotEmpty String lastName,
			@NotEmpty @Email String emailID, @NotEmpty String dateOfBirth, Address billingAddress) {
		super();
